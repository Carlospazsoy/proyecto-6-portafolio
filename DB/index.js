const datos = [
  {
    ...
    title: "Proyecto 1",
    texto:
      "En este proyecto se utilizaron unicamente los conceptos basicos de html y css para la creación de una landing page sobre un negocio de ceremonias alternativas.",
    fecha: "Landing Page",
    url1: "https://github.com/Carlospazsoy/Landing-page",
    url2: "https://carlospazsoy.github.io/Landing-page/",
  },
  {
    id: 2,
    title: "Proyecto 2",
    texto:
      "Este proyecto se centro en las operaciones basicas de un CRUD con javascript, como lo son crear, leer, actualizar y borrar informacion. Utilizando el local storage como almacenamiento persistente ",
    fecha: "CRUD",
  ...
  },
  {
    ...
    title: "Proyecto 4",
    texto:
      "Este proyecto se centro en las utilizacion de la navegación entre diferentes paginas, haciendo un de las router de React asi como la utilizacion de una base de datos en la nube con Firebase",
